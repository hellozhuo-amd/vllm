...
def _rocm_aiter_rmsnorm_gated_fp8_group_quant_impl(
    x: torch.Tensor,
    weight: torch.Tensor,
...
def _rocm_aiter_rmsnorm_gated_fp8_group_quant_fake(
    x: torch.Tensor,
    weight: torch.Tensor,
    bias: torch.Tensor | None,
    z: torch.Tensor,
...
class rocm_aiter_ops:
    ...
    def register_ops_once() -> None:
        ...
        if not _OPS_REGISTERED:
            ...
            direct_register_custom_op(
                op_name="rocm_aiter_rmsnorm_gated_fp8_group_quant",
                op_func=_rocm_aiter_rmsnorm_gated_fp8_group_quant_impl,
                fake_impl=_rocm_aiter_rmsnorm_gated_fp8_group_quant_fake,
            )
    ...
    @staticmethod
    def get_rmsnorm_gated_fp8_group_quant_op() -> OpOverload:
        return torch.ops.vllm.rocm_aiter_rmsnorm_gated_fp8_group_quant.default
