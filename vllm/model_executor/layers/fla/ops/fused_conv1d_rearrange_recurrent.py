...
def fused_rearrange_recurrent_gated_delta_rule_fwd_kernel(
    qkv,
    g,
    beta,
    o,
...
def fused_rearrange_recurrent_gated_delta_rule_fwd(
    ...
    grid = (NK, NV, N * HV)
    fused_rearrange_recurrent_gated_delta_rule_fwd_kernel[grid](
        qkv=qkv,
        g=g,
        beta=beta,
        o=o,
...
def fused_causal_conv1d_update_rearrange_recurrent_gated_delta_rule(
    ...
    bias: torch.Tensor | None = None, ## for conv1d
    activation: bool | str | None = None, ## for conv1d
    conv_state_indices: torch.Tensor | None = None, ## for conv1d
    validate_data=False, ## for conv1d
) -> tuple[torch.Tensor, torch.Tensor]:
    r"""
    Args:
        qkv (torch.Tensor):
